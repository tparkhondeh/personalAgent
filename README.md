...
- [دانلود همراه پایدار ۱۹](https://github.com/tparkhondeh/personalAgent/releases/download/phone-preview-stable-19/Hamrah-stable-19.apk)
- [مقایسه دقیق کد، Staging و APK؛ شناسه فایل و کارهای باقی‌مانده](docs/RELEASE_HANDOFF_2026-09-06.md)

APK و Staging از `17afb3d5e55ce984fc663068902db7125e9f7d77` هستند. Android 13/14/16 و کنترل‌های وب موفق‌اند؛ بررسی این نسخه روی گوشی مالک و Push واقعی هنوز باقی است. انتشار عمومی نسخه تازه انجام نشده؛ LLM واقعی و تماس واقعی فعال نیستند. لینک‌های نسخه‌های تاریخی پایین، نسخه پیشنهادی نصب نیستند.
...
مسیر معتبر فعلی تحویل، Workflow `Verified stable Android preview` است: [اجرای موفق نسخه ۱۹](https://github.com/tparkhondeh/personalAgent/actions/runs/34008659255). APK فقط پس از موفقیت هر سه Android منتشر می‌شود؛ همان فایل تحویلی نصب و آزموده شده است. روش‌های موقت زیر فقط سابقه‌اند و برای تحویل تازه نباید استفاده شوند.
