...
### تحویل نسخه شخصی۴۴ پس از بازبینی تخصصی — ۲۶ سپتامبر ۲۰۲۶

**tia۱٫۰٫۴۴ برای آزمون شخصی منتشر شد؛ نه اعلام تکمیل۱۰۰٪ یا پذیرش گوشی مالک.** [دانلود مستقیم](https://github.com/tparkhondeh/personalAgent/releases/download/personal-1.0.44/tia-1.0.44.apk) | [وب آزمایشی](https://personalagent.wealthos.ir:8443/) | [راهنمای تحویل و موانع](docs/PERSONAL_44_HANDOFF.md). کاندید اولیه۴۴ در آزمون توقف فوری رکورد ساختگی را از دست داد و هرگز منتشر نشد. فایل اصلاح‌شده از `6cd6e5902b9e1d47cda7f6b108c39b20165a87ce` فقط پس از تأیید ذخیره بومی موفقیت اعلام می‌کند؛ SHA آن `fa62f5b0f9e55270fc78f01dc16441162a7ba0e13337a81d8c24d2fcbfbfa377` است. همین فایل روی۱۳/۱۴/۱۶ کامل موفق و۱۵تصویر آن بازبینی شد. هیچ داده کاربر پاک نشد.

آخرین CI از `a970e402b3157538dfc44f306cc59648c7f71790` با۱۴۴۶/۱۴۴۶آزمون، Type Check، Lint و Build موفق است؛ مرورگر واقعی دسکتاپ/موبایل و Android16 داخلی نیز موفق‌اند. پذیرش همان فایل:۱۳ از شاخه موفق۳۶۲۳۹۳۱۳۷۱۶،۱۴/۱۶ از اجرای موفق۳۶۲۴۰۹۰۱۷۵۱، با۲۳تست بومی در هرکدام، ارتقای۴۳→۴۴، توقف فوری و حفظ همان ID/hash، صوت نمونه،۳۶۰شعر و لغو دقیق هشدار. این شواهد جای گوشی مالک نیستند. جزئیات شکست‌ها و اصلاحات بدون حذف شواهد قبلی در گزارش ثبت شده‌اند.

چهار زیرایجنت واقعی رابط، Android/آفلاین، بک‌اند/داده و امنیت/بودجه را بازبینی کرده‌اند. پشتیبان منبع و داده محلی و Staging در مقصدهای جدا بازیابی و بررسی شدند؛ اطلاعات کاربران، امضا، بودجه و Production حفظ شده‌اند. [گزارش شواهد و محدودیت‌ها](docs/FINAL_REVIEW_2026-09-26.md).

اصلاح تایپ تاریخ شمسی، تأیید پایدار آفلاین، لغو هشدارهای آینده و تحویل‌شده، خروج امن، مالکیت Push، حفظ فاصله سفارشی یادآوری و مهاجرت اتمی آزموده شدند. Staging همچنان منبع `3b2b24028346ce50a22959de72cac8c5c28b95cc` است؛ اصلاح بومی بعدی فایل APK را تغییر داد، نه Production. در12:28UTC، TLS معتبر، نسخه و کش صحیح و محدودیت API مهمان دوباره تأیید شد. GPT با دو پاسخ واقعی موفق و دفتر مشترک ماه۰٫۱۷۱۸۹۵دلار/سقف۲دلار در08:22UTC ثبت شد؛ صدای شخصی ارسال نشد و حساب آزمون از مصرف خارج شد.

**باقی‌مانده ضروری:** پذیرش اعلان/Alarm/پس‌زمینه/میکروفون/GPT روی گوشی مالک؛ بازیابی ایمیلی `available:false`؛ فضای سرور حدود۲٫۷۲GiB/۹۹٪مصرف؛ مقصد پشتیبان امن خارج سرور و بازیابی امضا خارج این پروفایل ویندوز. مدیر/مالک مسئول فراهم‌کردن این وابستگی‌ها هستند. تا رفع آن‌ها برنامه تنها محل اطلاعات حیاتی یا تنها راه هشدار حساس نباشد. داده آفلاین و حساب آنلاین دو مخزن جدا هستند؛ انتقال خودکار ادعا نمی‌شود. Production۴۴۳ تغییر نکرده؛ گزارش‌های پایین سابقه‌اند.

دانلود عمومی ناشناس در12:29UTC دوباره انجام شد و اندازه/SHA با همان APK آزموده‌شده برابر بود. secret موقت QA حذف شد؛ امضا، کلیدها و بودجه حفظ‌اند. فایل‌های داخلی آزمون منتشر نشدند و هیچ نصب/حذف روی گوشی مالک ادعا نمی‌شود.

### نسخه شخصی۴۳ منتشر شد؛ پذیرش نهایی گوشی باقی است — ۲۴ سپتامبر ۲۰۲۶ تهران

**tia۱٫۰٫۴۳ با امضای دائمی و همان Package ID۴۰، برای آزمون شخصی منتشر شد؛ نه اعلام تکمیل۱۰۰٪.** [دانلود مستقیم](https://github.com/tparkhondeh/personalAgent/releases/download/personal-1.0.43/tia-1.0.43.apk) | [وب آزمایشی](https://personalagent.wealthos.ir:8443/) | [راهنمای نصب، مشخصات، آزمون‌ها و موانع](docs/PERSONAL_43_HANDOFF.md).

همان APK با SHA `9d0353738ce22965c33e58fe495efd894a37419f2f03042b4917bef003db9406` در [Run35914897617](https://github.com/tparkhondeh/personalAgent/actions/runs/35914897617) روی۱۳/۱۴/۱۶ کامل موفق شد؛۱۴تست بومی در هرکدام، صوت نمونه، سه یادآوری و لغو،۳۶۰شعر، ثبت با تأیید، کیبورد، بازیابی و شروع عادی بدون عیب‌یابی بررسی شدند.۱۲تصویر بصری بدون پوشش خطا تأیید شدند. [CI وب35914858304](https://github.com/tparkhondeh/personalAgent/actions/runs/35914858304)، آزمون‌های تازه ابزار و مرورگر واقعی هم موفق‌اند. منبع APK `72f721f04a8ddc020879272203e7e972d51f9383` و منبع QA `048bc9fff4d3a60c3543e2dd35c35fe6d9d34777` است؛ آزمون دقیق فایل جدا از Build داخلی ثبت شد.

امضای جدید با آزمایشی۴۰ سازگار نیست؛ نصب تمیز همان اپ با رضایت مشخص مالک انجام‌پذیر است، اما هیچ حذف/نصب روی گوشی از این میزبان انجام نشده است. داده سرور/بودجه/حساب محفوظ‌اند و اجازه حذف قدیمی شامل داده تازه۴۳ نیست. کلید و رمز خارج Git/CI/APK، با پشتیبان خصوصی بررسی‌شده نگهداری شدند؛ بازیابی خارج این ویندوز هنوز ثابت نشده است.

GPT قبلاً روی سرور۸۴۴۳ واقعاً موفق بوده، ولی آزمون تازه GPT در Android به علت نبود اتصال TCP از شبکه CI به۸۴۴۳ اجرا نشد. تمام آماده‌سازی حساب آزمون جمع شد؛ فقط مالک بودجه دارد.۱۴رسید/۰٫۱۶۷۹۸۶دلار و صفر رزرو معلق، بدون هزینه تازه این مرحله، حفظ‌اند. لوکال مصرف مستقل ندارد. سرور همان `8dcfea6e3f9f42d871c0c864c0206e2d3de1575b` است؛ Production تغییر نکرد.

پذیرش اعلان/Alarm/میکروفون/GPT روی گوشی مالک، بازیابی ایمیلی، پشتیبان امن خارج سرور و ظرفیت سرور باقی‌اند. در۲۰:۳۸UTC حدود۲٫۷GiB آزاد/۹۹٪مصرف مشاهده شد؛ چیزی برای آزادسازی حذف نشد. پشتیبان روزانه و بازیابی جدا روی همان سرور موفق‌اند، نه حفاظت از نابودی کامل سرور. تا رفع محدودیت‌ها، تنها نسخه اطلاعات حیاتی در برنامه نگهداری نشود. دانلود عمومی دوباره انجام و SHA همان فایل آزموده‌شده احراز شد؛ ابزارهای داخلی و کلید منتشر نشدند. گزارش‌های پایین صرفاً سابقه‌اند.

### تأیید امضای دائمی و آماده‌سازی نسخه شخصی — ۲۳ سپتامبر ۲۰۲۶

تأیید مشخص مالک دریافت شد. امضای دائمی با حفظ شناسه `ir.wealthos.personalagent.stable40` ساخته و پشتیبان خصوصی آن جدا بررسی شد؛ کلید یا رمز وارد Git و CI نمی‌شوند. این امضا با آزمایشی۴۰ متفاوت است و نصب تمیز لازم خواهد بود؛ داده‌های قدیمی همان گوشی طبق مجوز مالک مانع تحویل نیستند، اما هیچ اطلاعات سرور یا گوشی پاک نشده است. اطلاعات تازه نسخه تحویلی مشمول آن مجوز نیستند.

مسیر ساخت نسخه غیرقابل‌عیب‌یابی و آزمون **همان فایل امضاشده** روی اندروید۱۳/۱۴/۱۶ در حال آماده‌سازی است. هنوز APK تازه منتشر یا نهایی اعلام نشده؛ برنامه قبلی فعلاً حذف نشود. [شواهد، پشتیبان و محدودیت‌های فعلی](docs/PERSONAL_SIGNED_2026-09-23.md). تأیید قبلاً دریافت‌نشده در گزارش‌های پایین دیگر مانع نیست؛ بقیه محدودیت‌ها همچنان مستقل‌اند.
