...
پشتیبان و Restore هر ۱۸ جدول موفق؛ ۴۳۷ تست در ۴۹ فایل، Type Check، Lint و Build مجزا موفق‌اند. Build اولیه با ۲۳ worker کمبود حافظه داشت؛ تعداد worker فقط برای ساخت محلی مجزا به ۲ محدود شد و ساخت کامل تکرار/موفق شد. مرورگر واقعی با حساب ساختگی، بازشدن مرکز اعلان و نمایش صحیح رد مجوز را تأیید کرد. فایل Android/رابط آفلاین تغییر ندارد؛ APK ۴۰ حفظ می‌شود. نتیجه CI و استقرار فقط پس از تأیید واقعی به گزارش اضافه می‌شود؛ لوکال را معادل رفع روی گوشی نمی‌گیریم. Production، اطلاعات گوشی و تنظیمات دامنه تغییر نکردند.
