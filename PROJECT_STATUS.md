...
- آزمون‌های اولیه: ۲۰۱ تست و ۳۵ کنترل HTTP موفق؛ مرورگر واقعی، ثبت بدون ویرایش و اصلاح عنوان همان گفتگو با سه یادآوری را در حساب مصنوعی تأیید کرد. Build، Type Check، Lint و Android Lint موفق بودند؛ بازاجرای نهایی پس از آخرین اصلاح و تست APK هنوز در جریان‌اند.
...
- آزمون کیبورد واقعی شبیه‌ساز به مجموعه WebView اضافه شد؛ موفقیت هنوز ادعا نمی‌شود. APK و Staging تحویلی فعلاً نسخه ۲۷ هستند؛ مراحل انتشار و شواهد نهایی در همین بخش به‌روز خواهند شد. Production دست‌نخورده است.
