...
### بازبینی تخصصی و کاندید اصلاحی۴۴ — ۲۶ سپتامبر ۲۰۲۶

**مانع تازهٔ تحویل، در حال اصلاح:** آزمون همان APK۴۴ در Run۳۶۲۳۵۳۱۹۵۴۹ نشان داد کار ثبت‌شده از فرم واقعی، با توقف اجباری ظرف حداکثر۲۵۶میلی‌ثانیه پس از شروع درخواست، در بازکردن سرد موجود نبود؛ پیام موفقیت پیش از آن دیده شده بود. بستن عادی و ارتقای۴۳→۴۴ موفق‌اند، اما این شکست واقعی محصول است و۴۴ منتشر نمی‌شود. فقط داده ساختگی شبیه‌ساز استفاده شد؛ داده کاربران پاک نشد. اصلاح با تأیید ذخیره پایدار پیش از اعلام موفقیت و بازبینی مستقل در جریان است؛ نتیجه نهایی باید با APK بازساخته و همان آزمون اثبات شود.

اصلاح ذخیره بومی و رابط اکنون پیاده‌سازی شده و۱۳۵۹/۱۳۵۹آزمون کد، Type Check، Build و بررسی واقعی مرورگر موفق‌اند. موفقیت این مرحله، رفع قطعی نقص روی APK نیست؛ ساخت مجدد هم‌امضا و آزمون توقف فوری/شروع سرد روی همان فایل هنوز شرط انتشار است. جزئیات شکست و اصلاح بدون حذف شواهد قبلی در گزارش ثبت شده‌اند.
...
اصلاح تاریخ شمسی، پایداری تأیید آفلاین، لغو هشدارهای آینده و تحویل‌شده، خروج امن از حساب، حفظ فاصله سفارشی یادآوری و مهاجرت اتمی در حال آزمون نهایی است. **در این نقطه۴۴ منتشر نشده؛ آخرین دانلود عمومی همچنان۴۳ است.** موفقیت آزمون‌های هدفمند جای Build نهایی، آزمون همان فایل۴۴ و پذیرش گوشی مالک نیست. Production۴۴۳، بازیابی ایمیلی، پشتیبان خارج سرور و ظرفیت سرور جداگانه محدودیت دارند؛ گزارش‌های پایین سابقه‌اند.
