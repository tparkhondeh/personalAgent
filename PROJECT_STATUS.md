...
- مرحله فعلی: بازطراحی پالت روشن پاستیلی پس از کاندید انتشار سوم تکمیل و روی نسخه محلی آزمایش شده است
- آخرین مرحله کامل: پالت یاسی، آبی آسمانی، سبز نعنایی و هلویی با سطوح شیشه‌ای روشن، کنتراست استاندارد و حالت تاریک هماهنگ شد
- قدم بعدی: انتقال کنترل‌شده Production و سپس امضای خصوصی Android؛ هر دو فقط پس از تأیید نهایی مالک و پس از همراه‌کردن بازطراحی جدید در کاندید انتشار بعدی
...
- طراحی: فونت وزیرمتن از داخل پروژه بارگذاری می‌شود؛ عنوان ۲۷ تا ۳۲ پیکسل، متن اصلی ۱۵ پیکسل و کنترل‌های لمسی حداقل ۳۸ پیکسل هستند. پالت روشن جدید از یاسی، آبی، نعنایی و هلویی استفاده می‌کند؛ نقاط عملیاتی برای خوانایی عمیق‌ترند و در بررسی واقعی مرورگر سرریز افقی یا کنترل کوچک مشاهده نشد
