...
- مرحله فعلی: علت صفحه سفید نسخه ۱۳ (پایان آدرس موقت Pinggy) رفع شده؛ Staging پایدار و APK دارای رابط محلی و صفحه بازیابی آماده کنترل نهایی است
- قدم بعدی: اجرای خودکار همان APK تحویلی روی Android 13، 14 و 16 و انتشار آن فقط در صورت نمایش متن واقعی فارسی در همه حالت‌ها
...
| اپلیکیشن Android | ۹۸٪ پیش از تأیید ابری تازه | رابط کامل در حالت متصل، رابط کاربردی داخل APK، صفحه بازیابی فارسی، Timeout و ثبت خطا کامل است؛ ماتریس تازه Android 13/14/16 در نوبت اجراست |
