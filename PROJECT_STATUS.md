...
پیش‌فرض روشن و انتخاب صریح تیره، منبع رنگ مشترک وب/Android، شعر دو ستونه و فاصله‌های کمتر در دست تکمیل آزمون است. نسخه تحویلی قبلی همچنان APK ۲۸ است؛ هنوز APK تازه منتشر نشده است. Backup کامل کد/Git و دیتابیس گرفته شد. ۲۱۸ تست، Type Check، Lint و Build اولیه و مرورگر واقعی ۱۲۸۰/۳۹۰/۳۲۰ موفق؛ کنترل‌های نهایی Android و انتشار بعد از آن باقی‌اند. [شواهد و روش بازگشت](docs/APPEARANCE_2026-09-06.md). Production تغییر نکرده است.
