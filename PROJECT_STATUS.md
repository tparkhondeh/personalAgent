...
### کارهای انجام‌شده فقط در آمار — ۱۰ سپتامبر ۲۰۲۶، در حال آزمایش انتشار
...
- ۲۷۶ آزمون در ۴۱ فایل، Type Check، Lint و Build وب موفق. ۲۶ کنترل HTTP اختصاصی (شامل داده آزمایشی رابط) و ۲۷ کنترل تأیید دستیار موفق؛ تکمیل تکراری، سه یادآوری، لغو پیگیری و حفظ رکورد بررسی شد. آزمون‌های بیشتر ساخت حساب به محدودیت واقعی ۵ ثبت‌نام در ساعت خوردند؛ محدودیت تغییر نکرد و آزمون کامل CI با دیتابیس جدا ادامه دارد.
- مرورگر واقعی وب: تکمیل کار، کاهش آمار، نبود مورد در تقویم و ماندگاری پس از reload تأیید شد. انتشار APK جدید و Android 13/14/16 هنوز در انتظار؛ نسخه ۳۹ را نسخه این اصلاح حساب نکنید. Staging و Production تا این نقطه تغییر نکرده‌اند.
