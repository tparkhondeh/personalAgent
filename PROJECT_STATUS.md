...
### در حال تأیید نسخه تازه — چهار باکس و شعر بعدی، ۸ سپتامبر ۲۰۲۶
...
- وب و منبع رابط آفلاین اصلاح شدند؛ APK و Staging هنوز نسخه ۳۷ هستند و به‌روزرسانی‌شده محسوب نمی‌شوند. مسیر انتشار تازه باید هر سه Android و بررسی بصری را بگذراند.
...
- ۲۵۶ تست، Type Check، Lint و Build وب موفق؛ آزمون HTTP ساخت/تکمیل/بازگرداندن/حذف جلسه و سه یادآوری موفق. مرورگر واقعی: تغییر شعر و حفظ پس از reload، شمارش و فیلتر، تکمیل جلسه متصل و ثبت/تکمیل کار آفلاین بررسی شدند. بازبینی عرض‌های بیشتر و آزمون همان APK هنوز ادامه دارد؛ هیچ ادعای پذیرش گوشی واقعی نمی‌شود.
- باقی‌مانده خارجی: میکروفون/شبکه واقعی مالک، کلید و رضایت هزینه LLM، Push واقعی و تماس/پیامک. Production دست‌نخورده؛ سرویس‌های پولی فعال نشده‌اند.

### تحویل تازه قابل‌آزمایش: tia و تبدیل صوت — نسخه ۳۷، ۷ سپتامبر تهران
