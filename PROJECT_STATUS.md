...
- مرحله فعلی: کاندید انتشار سوم روی محیط آزمایشی سرور نصب و با عملیات واقعی بررسی شده است
- آخرین مرحله کامل: بسته مستقل سرور، Migration، دو Scheduler، وب/PWA و APK متصل به دامنه نهایی در GitHub Actions و روی سرور آزمایشی تأیید شدند
- قدم بعدی: انتقال کنترل‌شده Production و سپس امضای خصوصی Android؛ هر دو فقط پس از تأیید نهایی مالک
