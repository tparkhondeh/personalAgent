...
- پیشرفت کل محدوده پیش از Production شامل Android و هشدار پیشرفته: **۹۵٪ تخمینی؛ هماهنگی نسخه تازه در حال آزمون**
- پیشرفت کل تا انتشار عمومی: **۹۰٪ تخمینی؛ سرویس‌های واقعی و انتشار عمومی معوق‌اند**
- مرحله فعلی: نسخه ۱۴ آخرین APK منتشرشده است، اما تغییرات پس از آن هنوز در Staging و رابط داخل آن نیستند؛ نسخه هماهنگ تازه در حال ساخت و آزمون است
- قدم بعدی: انتشار APK تازه پس از تست Android 13/14/16، ارتقای فقط Staging با Backup، سپس آزمایش مالک و تصمیم جداگانه Production
...
| شناخت کاربر | ۱۰۰٪ | ساعت و روز کاری، زمان سکوت، سبک برنامه‌ریزی و انتخاب هم‌زمان دو یا سه یادآوری پیش‌فرض ذخیره می‌شود |
...
| LLM و Agent | ۹۰٪ | اتصال OpenAI و مدل `gpt-5-mini` آماده است، اما کلید API در لوکال و سرور تنظیم نشده و حالت محلی فعال است |
...
| هشدار فوری چندمرحله‌ای | ۱۰۰٪ در محدوده فعلی | اعلان و Alarm کامل‌اند؛ مسیر تماس واقعی کاوه‌نگار با حالت خاموش امن، شماره Allowlist‌شده و Audit آماده است، اما حساب/کلید/اعتبار سرویس هنوز وجود ندارد |
