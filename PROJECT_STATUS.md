...
### در حال آزمون: صوت فارسی و صحت/چیدمان شعر — ۹ سپتامبر ۲۰۲۶
...
- سرویس خصوصی Shenava فقط روی loopback محیط آزمایشی نصب شد؛ انتشار وب جدید برای نمایش انتخاب صریح ارسال همان صدا به سرور هنوز باقی است. حالت آفلاین همچنان بدون ارسال صدا کار می‌کند. هیچ سرویس پولی یا LLM خارجی فعال نشده است.
- تا این نقطه: ۲۷۵ تست وب در ۴۱ فایل، Type Check، Lint، Build، ۴۲ کنترل HTTP لوکال و ۶ آزمون امنیتی سرویس موفق. تمام ۳۶۰ شعر در مرورگر واقعی در عرض‌های ۳۲۰/۳۹۰/۱۲۸۰ و متن دو برابر بدون حذف کلمه یا بریدگی بررسی شدند؛ دکمه شعر بعدی، تایپ و منع ثبت بدون ورود نیز بررسی شد. ساخت/آزمون APK تازه و بررسی تصویرها در ادامه است؛ آخرین APK تحویلی هنوز ۳۸ است، نه نسخه این تغییرات. [شواهد و محدودیت‌ها](docs/SPEECH_POEMS_2026-09-09.md).
