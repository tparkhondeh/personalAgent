...
کاندید داخلی41 در هر سه Android رد شد: بعد از ثبت اول، انتظار پاسخ زنگ دکمه فرم بعدی را قفل می‌کرد. ایراد بدون حذف آزمون رفع و در42 ثبت پشت‌سرهم موفق شد؛41 منتشر نشد.42 داخلی با SHA ثبت‌شده در گزارش ساخته شده، نه به‌عنوان آپدیت امن40. Android13 تمام سناریوها و۱۲تست بومی را گذراند؛ Android16 پس از گذر آزمون بومی/ثبت، با خطای ابزار UIAutomator متوقف شد و همان فایل بدون بازسازی دوباره آزموده می‌شود. نتیجه باقی‌مانده پس از مشاهده ثبت می‌شود. APK40 همچنان آخرین نسخه منتشرشده است؛ امضای موجود با40 سازگار نیست و آپدیت امن گوشی هنوز نیازمند احراز حفظ اطلاعات است. نصب/حذف برنامه گوشی، تغییر کلید و CDN انجام نشده؛ آزمایش واقعی صدا و محل ذخیره اطلاعات گوشی باقی است.
