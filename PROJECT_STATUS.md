...
- قدم بعدی: تنظیم امن کلید OpenAI توسط مالک حساب و اجرای آزمایش زنده
...
- آزمایش واقعی مرورگر: رابط Agent و مدیریت امن نبود کلید سرویس موفق

## اقدام بیرونی موردنیاز

- `OPENAI_API_KEY` هنوز تنظیم نشده است. این کلید باید در فایل محیطی امن قرار بگیرد و هرگز وارد Git یا پیام عمومی نشود.
