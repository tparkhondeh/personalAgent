...
تغییرات فقط سرور و آزمون‌ها هستند؛ APK ۴۰ و رابط آفلاین آن تغییر نکرده‌اند و هش فایل با Release یکسان است؛ APK تازه لازم نیست. Production و تنظیمات مشترک دامنه دست‌نخورده‌اند. تأیید بسته CI و نصب محدود Staging در ادامه همین مرحله ثبت می‌شود؛ Staging فعلی هنگام بررسی `be77c3a` بود. موارد خارجی در آخر قرار دارند: پاسخ تیکت ۵۲۴۰۷ و تحویل سالم HTTPS، پذیرش واقعی گوشی/صوت/Push/Alarm، کلید و سقف هزینه LLM، و تصمیم امضا/انتقال نهایی Production.
