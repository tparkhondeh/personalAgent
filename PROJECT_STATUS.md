...
آزمون سه Android/CI و نتیجه انتقال Staging جدا ثبت می‌شوند. APK40 هنوز آخرین نسخه منتشرشده است؛ کلید امضای موجود با آن سازگار نیست، بنابراین این تغییرات هنوز آپدیت امن گوشی محسوب نمی‌شوند. نصب/حذف برنامه یا تغییر شناسه انجام نشده است. دریافت واقعی صدا و وضعیت ذخیره اطلاعات گوشی باید جدا احراز شوند.
