...
### کارت تأیید کوتاه و تشخیص عنوان — در حال کنترل نسخه تازه، ۲۰۲۶-۰۹-۰۶
...
- APK ۲۸ از `f363336070cf1d84968b95013c07cbb52e5bbf83` ساخته شد؛ Android 13/16 شامل کیبورد واقعی، ۱۱ تست بومی هرکدام و خطاهای اتصال موفق‌اند. Android 14 پیش از نصب به ANR خود Pixel Launcher برخورد کرد و درست متوقف شد؛ تصاویر آن موفق محسوب نشدند. بازآزمایی همان فایل بدون بازسازی لازم است. [گزارش مرحله و شواهد](docs/COMPACT_APPROVAL_2026-09-06.md).
- ارتقای Staging به‌دلیل کمبود شدید فضای دیسک قبل از اجرا متوقف شد؛ Health فعلاً سالم و Commit فعال همچنان نسخه ۲۷ (`f3ad613`) است. `/tmp` یک loopback روی `/usr/tmpDSK` همان دیسک است و فضای مستقل محسوب نمی‌شود. Production، فرایندهای برنامه و داده‌های کاربر تغییر نکردند. فایل‌های آزمونی جابه‌جاشده و مسیر بازیابی در گزارش ثبت‌اند.
