...
آزمون تازه Android16 در Run35068078138 با Crash واقعی فرایند برنامه در WebView شکست خورد و موفق حساب نشد. آماده‌سازی استاندارد شبیه‌ساز به CI داخلی اضافه شد؛ کنترل متن واقعی فارسی، تصویر بدون خطای سیستم و Logcat نیز اکنون الزامی است. بازآزمایی هنوز نتیجه ندارد. این تغییر فقط مسیر آزمون است، نه رفع قطعی Crash گوشی یا انتشار APK تازه.
