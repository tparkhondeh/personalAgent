...
- پیشرفت نسخه وب/PWA: حدود **۹۷٪**
- پیشرفت کل محدوده جدید شامل Android و هشدار پیشرفته: حدود **۷۴٪**
- مرحله فعلی: آماده‌سازی اپلیکیشن Android
- آخرین مرحله کامل: بازطراحی تایپوگرافی و ظاهر با فونت محلی وزیرمتن
- قدم بعدی: افزودن پوسته Android با Capacitor و آماده‌سازی Build آزمایشی
...
| اپلیکیشن Android | ۰٪ | ساخت پوسته بومی، اتصال قابلیت‌ها و آماده‌سازی APK |
| هشدار فوری چندمرحله‌ای | ۲۰٪ | یادآوری و Push موجود است؛ Alarm بومی و Mock تماس/پیامک باقی مانده |
