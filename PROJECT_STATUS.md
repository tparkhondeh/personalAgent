...
### در حال آزمایش: tia و تبدیل واقعی فارسی روی دستگاه — ۲۰۲۶-۰۹-۰۶
...
هنوز نسخه APK تازه منتشر نشده و Staging/Production تغییر نکرده‌اند. تا پایان آزمون‌ها نسخه ۳۴ را به‌روز فرض نکنید.
