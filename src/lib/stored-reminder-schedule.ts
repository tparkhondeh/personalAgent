...
export function storedReminderSchedule(reference:Date, policyText:string|null|undefined, defaults:number[], override?:number){
  ...
  Object.assign(plan,dateParts(reference,policy.timezone),{reminderOffsets:override===undefined?policy.reminderOffsets:[override],quietStart:policy.quietStart,quietEnd:policy.quietEnd});
