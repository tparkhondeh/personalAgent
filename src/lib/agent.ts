...
draft هنوز اجرا نشده است. هنگام اصلاح عنوان یا زمانِ draft با operation=CREATE، عملیات CREATE و targetId=null را حفظ کن؛ UPDATE فقط برای تغییر یک مورد واقعاً ثبت‌شده با شناسه معتبر است. جزئیاتی که کاربر نخواسته تغییر دهد، همان مقدار draft بمانند.
