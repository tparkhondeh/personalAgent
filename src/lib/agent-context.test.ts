...
describe("agent context", () => {
  it("includes planning preferences and upcoming schedule", () => {
    const context = formatAgentContext({
      preference: { workdayStartsAt: "08:30", workdayEndsAt: "17:30", workingDays: "SAT,SUN", defaultReminderMins: 60, defaultReminderOffsets: "1440,180,60", quietHoursStartsAt: "22:00", quietHoursEndsAt: "08:00", planningProfile: "FOCUS" },
