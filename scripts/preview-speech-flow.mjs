...
const files=new Set(['app.css','theme.css','appearance.js','voice-capture.js','app.js','domain.js','planner.js','input-controls.js','content.js','Vazirmatn.woff2','speech/vosk-0.0.8.js','speech/fa-0.42.model']);
